...
export interface DisasterImage {
  ...
  location?: string;
  date?: string;
  /** Vendored public-domain photo (HISTORICAL only, with attribution). */
  image?: string;
...
export const IMAGE_SOURCES: DisasterImage[] = [
  ...
  { id: 'cyclone-ilsa', title: 'Cyclone Ilsa', category: 'cyclone', folder: '02_cyclone', source: 'NASA Earth Observatory', sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/cyclone-ilsa-37599/', license: 'NASA public domain', status: 'HISTORICAL', description: 'Documented cyclone case. Vendored photo; not a current event.', location: 'Indian Ocean', date: '2023-04', image: '/assets/drishti-x/real-world/02_cyclone/cyclone-ilsa.jpg', localVisual: '/img/dis-cyclone.svg' },
  { id: 'flood-india-north', title: 'Flooding in Northern India', category: 'flood', folder: '03_flood_india', source: 'NASA Earth Observatory', sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/flooding-in-northern-india-45933/', license: 'NASA public domain', status: 'HISTORICAL', description: 'Documented flood case. Vendored photo; not a current event.', location: 'Northern India', image: '/assets/drishti-x/real-world/03_flood_india/ganges-flood.jpg', localVisual: '/img/dis-flood.svg' },
  { id: 'flood-orissa', title: 'Floods in Orissa, India', category: 'flood', folder: '04_flood_orissa', source: 'NASA Earth Observatory', sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/floods-in-orissa-india-35390/', license: 'NASA public domain', status: 'HISTORICAL', description: 'Documented flood case. Vendored photo; not a current event.', location: 'Odisha, India', image: '/assets/drishti-x/real-world/04_flood_orissa/mahanadi-flood.jpg', localVisual: '/img/dis-flood.svg' },
  { id: 'landslide-debris-flow', title: 'Deadly Debris Flow in India', category: 'landslide', folder: '05_landslide_india', source: 'NASA Earth Observatory', sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/a-deadly-debris-flow-in-india-147973/', license: 'NASA public domain', status: 'HISTORICAL', description: 'Documented debris-flow case. Vendored photo; not a current event.', location: 'India', image: '/assets/drishti-x/real-world/05_landslide_india/debris-flow.jpg', localVisual: '/img/dis-landslide.svg' },
  ...
  { id: 'lightning-india', title: 'India Lightning Flash Rate Map', category: 'lightning', folder: '10_lightning', source: 'NASA Earth Observatory', sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/weeks-of-extreme-weather-in-india-92196/', license: 'NASA public domain', status: 'HISTORICAL', description: 'Documented extreme-weather case. Vendored image; not a current event.', location: 'India', image: '/assets/drishti-x/real-world/10_lightning/lightning-flashrate.png', localVisual: '/img/dis-storm.svg' },
