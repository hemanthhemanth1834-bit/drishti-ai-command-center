...
export const IMAGE_ASSETS: ImageAsset[] = [
  ...
  },
  {
    ...
    title: 'Helicopter flood rescue during Hurricane Harvey relief',
    ...
    licenseUrl: PD_FEDERAL_LICENSE_URL,
    localPath: '/img/photos/emergency-rescue.jpg',
    category: 'response',
    location: 'Texas, USA (Hurricane Harvey relief)',
    dateAccessed: '2026-09-24',
    description: 'U.S. Navy helicopter flood rescue — real search-and-rescue context, not a drone feed.',
    usageNotes: 'ARCHIVAL SAR CONTEXT. Rescue operations only — never presented as a live DRISHTI-X drone feed or a local event.',
    isReal: true,
    isIllustrative: false,
  },
  {
    ...
    source: 'NASA Earth Observatory record 37599',
    sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/cyclone-ilsa-37599/',
    license: 'Public domain (NASA)',
    licenseUrl: PD_NASA_LICENSE_URL,
    localPath: '/assets/drishti-x/real-world/02_cyclone/cyclone-ilsa.jpg',
    category: 'cyclone',
    dateAccessed: '2026-09-24',
    description: 'NASA Earth Observatory cyclone observation — historical cyclone context.',
    usageNotes: 'HISTORICAL CYCLONE CONTEXT. Also consumed by the history/satellite gallery via config/imageSources.ts.',
    isReal: true,
    isIllustrative: false,
  },
  {
    id: 'flood-ganges-eo',
    title: 'Flooding in Northern India satellite observation',
    ...
    license: 'Public domain (NASA)',
    licenseUrl: PD_NASA_LICENSE_URL,
    localPath: '/assets/drishti-x/real-world/03_flood_india/ganges-flood.jpg',
    category: 'flood',
    location: 'Northern India',
    dateAccessed: '2026-09-24',
    description: 'NASA Earth Observatory flood observation over northern India.',
    usageNotes: 'HISTORICAL FLOOD CONTEXT. Also consumed by the history gallery via config/imageSources.ts.',
    isReal: true,
    isIllustrative: false,
  },
  {
    id: 'flood-mahanadi-eo',
    title: 'Floods in Orissa (Mahanadi) satellite observation',
    source: 'NASA Earth Observatory record 35390',
    sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/floods-in-orissa-india-35390/',
    license: 'Public domain (NASA)',
    licenseUrl: PD_NASA_LICENSE_URL,
    localPath: '/assets/drishti-x/real-world/04_flood_orissa/mahanadi-flood.jpg',
    category: 'flood',
    location: 'Orissa, India',
    dateAccessed: '2026-09-24',
    description: 'NASA Earth Observatory flood observation over Orissa, India.',
    usageNotes: 'HISTORICAL FLOOD CONTEXT. Also consumed by the history gallery via config/imageSources.ts.',
    isReal: true,
    isIllustrative: false,
  },
  {
    id: 'landslide-debris-flow-eo',
    title: 'Deadly debris flow in India satellite observation',
    ...
    license: 'Public domain (NASA)',
    licenseUrl: PD_NASA_LICENSE_URL,
    localPath: '/assets/drishti-x/real-world/05_landslide_india/debris-flow.jpg',
    category: 'landslide',
    location: 'India',
    dateAccessed: '2026-09-24',
    description: 'NASA Earth Observatory debris-flow observation — real slope-failure context for detection reference.',
    usageNotes: 'HISTORICAL LANDSLIDE CONTEXT. Also consumed by the history gallery via config/imageSources.ts.',
    isReal: true,
    isIllustrative: false,
  },
  {
    id: 'storm-lightning-flashrate',
    title: 'India lightning flash-rate map',
    source: 'NASA Earth Observatory record 92196',
    sourceUrl: 'https://science.nasa.gov/earth/earth-observatory/weeks-of-extreme-weather-in-india-92196/',
    license: 'Public domain (NASA)',
    licenseUrl: PD_NASA_LICENSE_URL,
    localPath: '/assets/drishti-x/real-world/10_lightning/lightning-flashrate.png',
    category: 'weather',
    location: 'India',
    dateAccessed: '2026-09-24',
    description: 'NASA lightning flash-rate map render over India — a data visualization, not a photograph.',
    usageNotes: 'HISTORICAL STORM DATA-VISUALIZATION. Consumed by the history gallery via config/imageSources.ts.',
    isReal: true,
    isIllustrative: false,
  },
];
